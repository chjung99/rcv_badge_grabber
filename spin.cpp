...
int spin::DisableHeartbeat(INodeMap& nodeMap, INodeMap& nodeMapTLDevice)
{
...
int spin::AcquireImages(CameraPtr pCam, INodeMap& nodeMap, INodeMap& nodeMapTLDevice)
{
	int result = 0;
...
int spin::PrintDeviceInfo(INodeMap& nodeMap)
{
	int result = 0;
...
int spin::RunSingleCamera(CameraPtr pCam)
{
	int result;
